...
namespace CronExpression.Internals {
	...
	sealed class DayOfWeekCronInterval : CronInterval {
		...
		public DayOfWeekCronInterval(params string[] partCollection) {
		...
		public static DayOfWeekCronInterval Parse(string parts) {
			...
			return new DayOfWeekCronInterval(q.ToArray());
		}
		...
		public static void Validate(string parts) {
			...
			// TODO: Code Dept, we need to isolate individual value validators into shared code
			new HourCronInterval(q.ToArray())
