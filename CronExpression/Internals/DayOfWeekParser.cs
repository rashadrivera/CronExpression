...
namespace CronExpression.Internals {
	...
	sealed class DayOfWeekParser : Parser {

		const int MAX_VALUE = 7;

		readonly ICronValue[] _Values;

		public DayOfWeekParser(params string[] partCollection) {
		...
		public static DayOfWeekParser Parse(string parts) {
			...
			return new DayOfWeekParser(q.ToArray());
		}
